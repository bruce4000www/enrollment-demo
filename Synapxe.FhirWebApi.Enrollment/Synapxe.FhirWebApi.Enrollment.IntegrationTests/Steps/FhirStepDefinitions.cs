...
namespace Synapxe.FhirWebApi.Enrollment.IntegrationTests.Steps
{
    [Binding]
    public sealed class FhirStepDefinitions
    {
        ...
        public async Task WhenResourceCreatedApptIsUpdatedWithDataAsUpdatedAppt(string reference, string destination, Table table)
        {
